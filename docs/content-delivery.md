            ...
            for q in questions {
                ...
                let stmt = try db.prepare("""
                    ...
                    (id, section, module, q_type, passage, question,
                     option_a, option_b, option_c, option_d, answer, source_pdf)
                    VALUES (?,?,?,?,?,?,?,?,?,?,?,?)
                """)
                ...
                try SQLiteDB.bind(stmt, 7, opts["A"])
                try SQLiteDB.bind(stmt, 8, opts["B"])
                try SQLiteDB.bind(stmt, 9, opts["C"])
                try SQLiteDB.bind(stmt, 10, opts["D"])
